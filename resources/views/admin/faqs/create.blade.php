            ...
            <div class="bg-[#111] border border-[#1a1a1a] rounded-2xl p-8 shadow-2xl">
                <form action="{{ route('admin.faqs.store') }}" method="POST">
                    ...
                    <div class="mb-8 border-b border-[#1a1a1a] pb-6">
                        <h3 class="text-2xl font-bold text-white mb-2">تفاصيل السؤال</h3>
                        <p class="text-gray-400 text-sm">أدخل السؤال والإجابة باللغتين.</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                        <div>
                            ...
                            <textarea name="answer_en" rows="5" required
                                class="w-full bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#E60914] transition placeholder-gray-600 resize-y"></textarea>
                        </div>
                        <div>
                            <label class="block text-gray-400 text-sm mb-2">الإجابة (عربي)</label>
                            <textarea name="answer_ar" rows="5" required
                                class="w-full bg-[#0a0a0a] border border-[#1a1a1a] rounded-lg px-4 py-3 text-white focus:outline-none focus:border-[#E60914] transition placeholder-gray-600 resize-y" dir="rtl"></textarea>
                        </div>
                    </div>
