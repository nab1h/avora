<nav x-data="{ open: false }" class="bg-black border-b border-[#1a1a1a]">
        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-[#1a1a1a] text-sm leading-4 font-medium rounded-lg text-gray-300 bg-[#111111] hover:bg-[#E60914]/10 hover:text-white hover:border-[#E60914] focus:outline-none transition ease-in-out duration-150">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden bg-[#0a0a0a] border-t border-[#1a1a1a]">
        ...
        <div class="pt-4 pb-1 border-t border-[#1a1a1a]">
            <div class="px-4">
